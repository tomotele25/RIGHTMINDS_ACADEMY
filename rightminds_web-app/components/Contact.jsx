...
const Contact = () => {
  return (
    <div id="contact">
      <div>
        <h1 className="text-3xl sm:text-4xl flex justify-center">
          Get In Touch
        </h1>
      </div>

      <div className=" grid gap-10 w-full  sm:flex sm:justify-between   pl-14 p-7 ">
        <form className="grid w-10/12   bg-slate-50 shadow-2xl p-3 py-10">
        ...
        <div className="w-10/12 p-5 grid gap-2  ">
          <h1>Call Us</h1>
          <p>09152580773 </p>
